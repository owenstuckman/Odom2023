...
@TeleOp(name = "OpenCvLeftONLYPARK", group = "Default")
public class OpenCVLeft extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (pipeline.getAnalysis() >= 135) {

                coneColor = "pink";
                break;
            }
            if (pipeline.getAnalysis() <= 95 && pipeline.getAnalysis() >= 75) {

                coneColor = "blue";
                break;
            }
            if (pipeline.getAnalysis() >= 100 && pipeline.getAnalysis() <= 130){
                coneColor = "green";
                break;
        ...
        while (opModeIsActive()){
            ...
            if (coneColor.equals("pink")) {


                // movement based on cone
                DriveForward(.7,600);
                sleep(sleepTime);
                StrafeLeft(.5,1000); // need to test - just a placeholder
                sleep(30000);

            }
            if (coneColor.equals("green")) {
            ...
            if (coneColor.equals("blue")) {
                ...
                // movement based on cone
                DriveForward(.7,1200);
                StrafeRight(.5,1000); // need to test - just a placeholder
                sleep(30000);
...
*/
    ...
    public void openClaw(int time) {
        clawSystem.claw.setPosition(0.4);
        sleep(time);

    }

    public void closeClaw(int time) {
        clawSystem.claw.setPosition(0.62);
        sleep(time);
